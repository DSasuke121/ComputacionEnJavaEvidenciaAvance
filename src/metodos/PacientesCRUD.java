...
public class PacientesCRUD {
    ...
    public void agregarPaciente(Paciente p){
        ...
        try{
            FileInputStream leer =
                    new FileInputStream("C:\\ComputacionEnJAVA\\EvidenciaFinal\\basedatos\\pacientes.txt");
            ...
            FileOutputStream escribir =
                    new FileOutputStream("C:\\ComputacionEnJAVA\\EvidenciaFinal\\basedatos\\pacientes.txt");
    ...
    public Paciente getInfoPacientePorCuenta(String numcuenta){
        //leer el archivo y traerse la lista de alumnos
        FileInputStream leer;
        try {
             leer = new FileInputStream("C:\\ComputacionEnJAVA\\EvidenciaFinal\\basedatos\\pacientes.txt");
            ...
            for(int i=0; i<listaPacientes.size();i++)
            {
                ...
                if(numcuenta.equals(k.getCuenta()))
                {
                    leer.close();
                   return k;
                }
